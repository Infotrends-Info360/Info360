                                ...
                                <ul style="list-style-type:none;margin-left:0px;">
                                    <li>
                                        ...
                                        <ul style="list-style-type:none;margin-left:20px;">
                                            ...
                                            <li onclick=""><i class="fa fa-fw fa-file-text-o"></i><a href="group_setting.jsp">部門權限管理</a></li>
                                            <li onclick=""><i class="fa fa-fw fa-file-text-o"></i><a href="agentreason_setting.jsp">值機狀態管理</a></li>
                                        </ul>
                                    </li>
<!--                                     <li class="active"> -->
<!--                                         <span> -->
...
<!--                                     </li> -->
                                    <li>
                                        <span>
                                         ...
                                         <ul style="list-style-type:none;margin-left:20px;">
                                            <li><i class="fa fa-fw fa-file-text-o"></i><a href="commlink_setting.jsp">常用連結管理</a></li>
                                            <li><i class="fa fa-fw fa-file-text-o"></i><a href="activity_menu_setting.jsp">服務代碼清單管理</a></li>
                                            <li><i class="fa fa-fw fa-file-text-o"></i><a href="activity_group_setting.jspl">服務代碼群組管理</a></li>
                                            <li><i class="fa fa-fw fa-file-text-o"></i><a href="activity_data_setting.jsp">服務代碼管理</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="col-lg-10 col-sm-9">
                <div class="panel panel-success" style="height:780px;">
                    ...
                    <div id="hrTabControlButton" style="margin:1px 0px 0px 1px;">
                        <button class="btn-sm btn-primary manage" onclick="showManage()"><i class="fa fa-fw fa-user"></i>常用連結管理</button>
<!--                         <button class="btn-sm btn-success ban" onclick="showBan()"><i class="fa fa-fw fa-user"></i>停用列表</button> -->
                        <button class="btn-sm btn-success addMember" style="display:none;"><span onclick="showAddMember()">新增常用連結</span> <i class="fa fa-times" onclick="closeAddMember()"></i></button>
                        <button class="btn-sm btn-success editMember" style="display:none;"><span onclick="showEditMember()">更新常用連結</span> <i class="fa fa-times" onclick="closeEditMember()"></i></button>
                    </div>
                    <!-- 常用連結管理切換頁籤End -->
...
<!--                                         <thead> -->
<!--                                             <tr> -->
<!--                                                 <th class="no-sort"><input type="checkbox" id="banCheck" ischecked=false></th> -->
<!--                                                 <th>帳號</th> -->
<!--                                                 <th>姓名</th> -->
<!--                                                 <th>員工編號</th> -->
<!--                                                 <th>分機號碼</th> -->
            ...
            <!-- Modal content-->
              <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" data-dismiss="modal" onclick="deletefunction('刪除成功')">確定</button>
...
// 		 			});
       	...
       	function play2() {
       	  $("#manageTable tbody tr,#banTable tbody tr,#treeTable tbody tr").on("click",function(){
                 var text = $(this).text();
                 if (text && text != "") {
                     showEditMember();
                 }
